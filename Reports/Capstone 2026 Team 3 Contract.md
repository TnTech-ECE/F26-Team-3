...
- Use a step-by-step approach to resolve issues:
  ...
  - Once discussed, a vote will occur based on majority to reach a conclusion
...
Listed below are the roles we have designated for our group:
...
If there is a role that is absent that may be best suited for a decision or task, the necessary duty will be distributed to those present.
...
Sean Ottaway, Lucy Dunn, Gabe Simpkins, Andrew Singletary, Nicolas Campbell